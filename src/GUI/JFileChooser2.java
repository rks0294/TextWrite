...
public class JFontChooser extends JComponent {
	...
	private class SelectionUpdater implements ChangeListener,
	...
	public JDialog createDialog(Component c, String title, boolean modal,
		...
		return new FontChooserDialog(c, title, modal, this, okListener,
				cancelListener);
	}
	...
	private void init(Font font) {
		...
		((JLabel) sizeList.getCellRenderer())
		...
		add(new JScrollPane(previewLabel), new GridBagConstraints(0, 3, 2, 1,
				1, 1, GridBagConstraints.CENTER, GridBagConstraints.BOTH, ins,
				0, 0));
	...
	private Font buildFont() {
		...
		return new Font(fontName, (italicCheckBox.isSelected() ? Font.ITALIC
				: Font.PLAIN)
...
class DefaultFontSelectionModel implements FontSelectionModel {
	...
	private static final Font DEFAULT_INITIAL_FONT = new Font("Dialog",
			Font.PLAIN, 12);
 ...
 * <pre>
 **/
public class JFileChooser2 extends JComponent
{
    // class variables
    /**
     ...
     **/
    public JFileChooser2(String[] fontSizeStrings)
    {
